"""Hermes plugin: agent-student — Student Jarvis learning tools (Phase 5)."""
...
def register(ctx) -> None:
    ...
    from agent_platform.integrations.hermes.student_tools import register_student_hermes_tools

    register_student_hermes_tools(ctx)
    logger.info("agent-student plugin loaded")
